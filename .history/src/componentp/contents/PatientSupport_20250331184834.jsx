              ...
              <Col md={4} className="mb-4">
                <Card className="quick-link-card">
                  <Card.Body className="text-center">
                    ...
                    <Button as={Link} to="/reminders" variant="primary">
                      Manage Reminders
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={6}>
                <Card>
                  <Card.Body>
                    ...
                    <ListGroup variant="flush">
                      <ListGroup.Item>
                        <FaPhone className="mr-2" /> Patient Hotline: +1 (555) 765-4321
                      </ListGroup.Item>
                      <ListGroup.Item>
                        <FaEnvelope className="mr-2" /> Email: patients@flowpharmacy.com
                      </ListGroup.Item>
                      <ListGroup.Item>
