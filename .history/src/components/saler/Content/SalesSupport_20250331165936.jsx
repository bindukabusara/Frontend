              ...
              <Col md={3} className="mb-4">
                <Card className="quick-link-card">
                  <Card.Body className="text-center">
                    ...
                    <Card.Text>
                      View your pharmacy's key metrics and analytics
                    </Card.Text>
              ...
              <Col md={3} className="mb-4">
                <Card className="quick-link-card">
                  <Card.Body className="text-center">
                    ...
                    <Button as={Link} to="/expiring" variant="primary">
                      Track Expiry
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={3} className="mb-4">
                <Card className="quick-link-card">
                  <Card.Body className="text-center">
                    ...
                    <Button as={Link} to="/stock" variant="primary">
                      Manage Stock
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={6}>
                <Card>
                  <Card.Body>
                    ...
                    <ListGroup variant="flush">
                      <ListGroup.Item>
                        <FaPhone className="mr-2" /> Support Hotline: +1 (555) 123-4567
                      </ListGroup.Item>
                      <ListGroup.Item>
