...
import ReminderPage from './componentp/contents/ReminderPage';
import PatientSupport from './componentp/contents/PatientSupport';
...
import SalesSupport from "./components/saler/Content/SalesSupport";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/salesupportS'element={<SalesSupport/>}/>
